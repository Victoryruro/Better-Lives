                            ...
                            <div className=' inline-block w-2/5 '>
                                ...
                                <input
                                    ...
                                    id="name"
                                        ...
                                        className='block w-full rounded-lg border border-gray-200 bg-gray-50 text-xl px-4 py-3 text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-primary-50 focus:ring-2 focus:ring-indigo-100 dark:border-gray-700! dark:bg-gray-800! dark:text-white! dark:placeholder:text-gray-500 dark:focus:ring-primary-50!'
                                />
                            </div>
                            <div className='inline-block w-2/5'>
                            ...
                            <div className='mb-4 block '>
                                ...
                                <textarea
                                    ...
                                    rows={8}
                                        ...
                                        className='block w-full text-xl resize-y rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-primary-50 focus:ring-2 focus:ring-indigo-100 dark:border-gray-700! dark:bg-gray-800! dark:text-white! dark:placeholder:text-gray-500 dark:focus:ring-primary-50!'
                                ></textarea>
                            </div>
                            <div>
                                <button
                                    type="submit"
                                        className='inline-flex lg:w-1/4 items-center justify-center gap-2 rounded-lg bg-primary-50 px-5 py-3 text-lg font-semibold text-white shadow-sm transition hover:bg-primary-50 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:ring-offset-2 dark:focus:ring-offset-gray-900'
                                >
                                    Send Message
